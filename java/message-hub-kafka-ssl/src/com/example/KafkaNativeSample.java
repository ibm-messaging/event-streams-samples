...
/**
 * Sample used for interacting with Message Hub over
 * Secure Kafka / Kafka Native channels.
 * @author IBM
 */
public class KafkaNativeSample
{
	...
	/**
	 * Create a message consumer, returning the thread object
	 * it will run on.
	 * @param broker	{String}	The host and port of the broker to interact with.
	 * @param apiKey	{String}	The API key used to connect to the Message Hub service.
	 * @param topic		{String}	The topic to consume on.
	...
	/**
	 * Create a message producer, returning the thread object
	 * it will run on.
	 * @param broker	{String}	The host and port of the broker to interact with.
	 * @param apiKey	{String}	The API key used to connect to the Message Hub service.
	 * @param topic		{String}	The topic to consume on.
	 * @param message	{String}	String representation of a JSON array of messages to send.
	 * @return	{Thread}	Thread object that the producer will run on.
	 */
	public static Thread createMessageProducer(String broker, String apiKey, String topic)
	{
		ProducerRunnable producerRunnable = new ProducerRunnable(broker, apiKey, topic);
	 ...
	 * @param broker 		{String} 	A string representing a list of brokers the producer can contact.
	 * @param apiKey 		{String}	The API key of the Bluemix Message Hub service.
	 * @param isProducer 	{Boolean}	Flag used to determine whether or not the configuration is for a producer.
