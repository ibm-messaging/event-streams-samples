...
public class EventStreamsConsoleSample {
    ...
    public static void main(String args[])  {
        try {
            ...
            if (runProducer) {
                Map<String, Object> producerConfigs = getProducerConfigs(bootstrapServers, apiKey, registrySerDesUrlWithAuth);
    ...
    static final Map<String, Object> getProducerConfigs(String bootstrapServers, String apikey, String registryURL) {
        Map<String, Object> configs = new HashMap<>();
        configs.put(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, StringSerializer.class.getName());
        configs.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, KafkaAvroSerializer.class.getName());
        configs.put(KafkaAvroSerializerConfig.SCHEMA_REGISTRY_URL_CONFIG, registryURL);
